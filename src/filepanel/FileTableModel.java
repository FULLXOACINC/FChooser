...
public class FileTableModel implements TableModel {
    ...
    private static final String DATE = "last modified ";
    private static final ImageIcon FILE = new ImageIcon("img/FILE_LITTLE.png");
    private static final ImageIcon DIRECTORY = new ImageIcon("img/DIRECTORY_LITTLE.png");
